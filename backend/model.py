...
class AudioCNN(nn.Module):
    def __init__(self, num_classes=50):
        ...
        self.layer1 = nn.ModuleList([ResidualBlock(64 if i==0 else 128, 128, stride=1) for i in range(3)])
        self.layer2 = nn.ModuleList([ResidualBlock(128 if i==0 else 256, 256, stride=2 if i==0 else 1) for i in range(4)])
        self.layer3 = nn.ModuleList([ResidualBlock(256 if i==0 else 512, 512, stride=2 if i==0 else 1) for i in range(6)])
        self.layer4 = nn.ModuleList([ResidualBlock(512 if i==0 else 1024, 1024, stride=2 if i==0 else 1) for i in range(3)])
